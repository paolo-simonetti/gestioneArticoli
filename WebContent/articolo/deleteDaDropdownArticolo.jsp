	...
	<main role="main" class="container">
		...
		<div class='card'>
		    <div class='card-header'>
		        <h5>Quale elemento vuoi eliminare?</h5> 
		    </div>
		    <div class='card-body'>

					<form method="post" action="PrepareDeleteArticoloDaDropdownServlet" 
					novalidate="novalidate">
					
						<div class="form-row">
							<div class="form-group col-md-6">
								<label>Id articolo </label>
								<input type="number" name="idArticoloDaEliminare" id="idArticoloDaEliminare" 
